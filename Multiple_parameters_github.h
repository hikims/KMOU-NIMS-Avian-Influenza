...
// // Time step considering numerical stability
// #define dt (0.0002)

// // Number of iterations and output interval
// #define iter (2000000)
// #define cut (1000)
...
inline constexpr double Lx     = 30.0;
inline constexpr double Ly     = 30.0;
inline constexpr int    Nx     = 1500;
inline constexpr int    Ny     = 1500;
